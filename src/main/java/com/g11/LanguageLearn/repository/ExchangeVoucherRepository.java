...
public interface ExchangeVoucherRepository extends JpaRepository<ExchangeVoucher,Integer> {
    @Query("select e.idExchangeVoucher,e.voucher.nameVoucher,e.voucher.pointVoucher,e.voucher.priceVoucher,e.statusVoucher from ExchangeVoucher e where e.user.idUser =:id order by ex.idExchangeVoucher DESC")
